...
This document describes version 1.05 of Getopt::Declare,
...
means that the arguments "-q" and "-Q" will both match the C<-q> parameter, but
that only "-v" (and I<not> "-V") will match the C<-v> parameter.
